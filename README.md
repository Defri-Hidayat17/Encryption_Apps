...
Aplikasi ini dirancang untuk memberikan pemahaman praktis mengenai cara kerja berbagai algoritma enkripsi klasik serta bagaimana sistem dapat mengelola proses dan data di dalamnya secara efisien.
...
## 🎯 Tujuan Pengembangan
1. Mengimplementasikan algoritma kriptografi klasik dalam bentuk aplikasi interaktif.  
...
| 🌈 **UI Modern** | Desain minimalis dengan kombinasi warna gelap-hijau gradien. |
